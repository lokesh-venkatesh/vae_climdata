...
plt.tight_layout()
plt.savefig("results/gen_plot1_average_seasonal_profile.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("results/gen_plot2_average_diurnal_profile.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("results/gen_plot3_last_two_weeks_of_hourly_data.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("results/gen_plot4_last_year_of_daily_averages.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("results/gen_plot5_autocorrelations.png", dpi=300, bbox_inches='tight')
plt.close()